    ...
    <div class="card-kpi p-3 mb-4">
        <div class="row align-items-end">
            ...
            <div class="col-lg-8 col-md-6 text-md-end">
                 <a href="forms/criarProduto.php" class="btn btn-purple"><i class="bi bi-plus-circle-fill me-2"></i> Cadastrar Produto</a>
            </div>
        </div>
    </div>
...
<script>
    ...
    function validarSenhaAdmin() {
        ...
        fetch('../../controllers/admin/senhaAdminCheck.php', {
            method: 'POST',
