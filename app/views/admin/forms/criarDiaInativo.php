...
if (!isset($_SESSION['usuario_id']) || $_SESSION['usuario_tipo'] != 1) {
    header("Location: ../usuario/login.php?erro=acessonegado"); exit();
}
...
<head>
    ...
    <title>Cadastrar Dia Inativo</title>
...
<div class="main-content">
    <header class="d-flex justify-content-between align-items-center mb-4">
        <h2>Cadastrar Dia/Período Inativo</h2>
    ...
    <div class="card-kpi">
        <form action="../../../controllers/admin/DiaInativoController.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control form-control-dark" name="data_inativa" required min="<?= date('Y-m-d') ?>">
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">Hora Início</label>
                    <input type="time" class="form-control form-control-dark" name="hora_inicio">
                    <div class="form-text text-white-50">Opcional: Deixe vazio para o dia todo.</div>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Hora Fim</label>
                    <input type="time" class="form-control form-control-dark" name="hora_fim">
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label">Motivo</label>
                <textarea class="form-control form-control-dark" name="motivo" rows="3"></textarea>
            </div>
