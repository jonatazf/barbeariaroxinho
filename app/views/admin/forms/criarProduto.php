...
<body>
    ...
    <div class="main-content container">
        <header class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="../estoque.php" class="btn btn-outline-light"><i class="bi bi-arrow-left me-2"></i> Voltar para o
                Estoque</a>
        </header>
        ...
        <div class="card-kpi p-4">
            <form action="../../../controllers/admin/estoqueController.php" method="POST">
                ...
                <div class="mb-3">
                    <label for="produto_nome" class="form-label">Nome do Produto <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control form-control-dark" id="produto_nome" name="produto_nome"
                        required>
                </div>

                <div class="mb-3">
                    <label for="produto_qtd" class="form-label">Quantidade Inicial <span
                            class="text-danger">*</span></label>
                    <input type="number" class="form-control form-control-dark" id="produto_qtd" name="produto_qtd"
