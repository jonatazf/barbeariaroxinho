...
-- Copiando dados para a tabela barbearia.agendamento: ~1 rows (aproximadamente)
INSERT INTO `agendamento` (`agen_id`, `agen_data_a`, `agen_hora_a`, `agen_data_c`, `usuario_id`, `corte_id`, `agen_status`) VALUES
	(1, '2025-10-08', '10:00:00', '2025-10-06 22:03:40', 6, 1, 'Confirmado');
...
-- Copiando dados para a tabela barbearia.corte: ~1 rows (aproximadamente)
INSERT INTO `corte` (`corte_id`, `corte_nome`, `corte_preco`, `corte_descricao`, `corte_foto`) VALUES
	(1, 'Corte 1', 10.00, 'Oi', 'A');
